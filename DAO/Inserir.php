<?php
    ...
    class Inserir{
        function cadastrarCliente(Conexao $conexao, string $cpf, string $nome, string $telefone, string $endereco, float $totalDeCompras){
            try{
                $conn = $conexao->conectar();//Abrir o banco
                $sql = "Insert into cliente(codigo, nome, telefone, endereco, total) values('$cpf', '$nome', '$telefone', '$endereco', '$totalDeCompras')";
        ...
        function cadastrarFuncionario(Conexao $conexao, string $cpf, string $nome, string $telefone, string $endereco, float $salario){
            try{
                ...
                return "<br><br>Aldo deu errado".$erro;
            }
        }//Fim do método
    }//Fim da classe
?>